    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-file-invoice" aria-hidden="true"></i><span class="app-menu__label">Reportes</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?= base_url(); ?>/reporte-pedidos"><i class="icon fa fa-circle-o"></i> Pedidos</a></li>
            <li><a class="treeview-item" href="<?= base_url(); ?>/reporte-publicidades"><i class="icon fa fa-circle-o"></i> Publicidades</a></li>
          </ul>
        </li>
      </ul>
    </aside>