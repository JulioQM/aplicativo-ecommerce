                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <form action="" role="form" id="formulario" class="formulario">
                                        ...
                                        <div class="card-footer">
                                            <a href="./confirmarCompra.php"><button type="button" class="subscribe btn btn-primary btn-block shadow-sm"> Confirmar Pago </button></a>
                                ...
                                <div id="paypal" class="tab-pane fade pt-5">
                                    ...
                                    <form action="datosImagen.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="file" name="imagen" size="20"><br><br>
                                    ...
                                    <a href="./confirmarCompra.php"> <br><button type="button" class="btn btn-primary "><i class="fas fa-mobile-alt mr-2"></i> Pagar con transferencia</button> </a>
                                ...
                                <div id="net-banking" class="tab-pane fade pt-3">
                                    <div class="form-group "> <label for="cbbPlazo">
                                            ...
                                            <option value="" selected disabled>--Porfavor elija un plazo--</option>
                                            <option>3 meses sin interes</option>
                                            <option>6 meses sin interes</option>
                                            <option>9 meses sin interes</option>
                                            <option>12 meses mas interes</option>
                                            <option>24 meses mas interes</option>

                                        </select> </div>
                                    <div class="form-group">
                                        <a href="./confirmarCompra.php"> <button type="button" class="btn btn-primary "><i class="fab fa-cc-amex"></i> Proceder al pago</button> </a>
